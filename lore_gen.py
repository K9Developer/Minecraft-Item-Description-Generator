...
def lore_box_generator(lore, text_y_offest=0, text_x_offest=0, frame_width_right_offset=0, frame_width_left_offset=0, frame_height_down_offest=0, frame_height_up_offest=0,line_spacing_offset=0, char_space_offest=0):
    l = []
    ...
    height = round(len(lore)*18/8 + (len(lore)-1)*12/8)-3 + frame_height_down_offest + frame_height_up_offest
    ...
    for t,i in enumerate(lore):
        ...
        char_width_history = []
        stroke = 0
        space_between_chars = 3+char_space_offest
        color =(170, 170, 170)
    ...
    lore_box.paste(text_box, (20+text_x_offest+(frame_width_left_offset*8),25+text_y_offest+(frame_height_up_offest*8)),mask=text_box)
...
lore = ['§aFractured Mithril Pickaxe', '§8Breaking Power 5', '', '§7Damage: §c+30', '§7Mining Speed: §a+310', '', '§9Efficiency V', '§7Grants §a+110 §6⸕ Mining', '§6Speed§7.', '§9Experience II', '§7Grants a §a25% §7chance for mobs', '§7and ores to drop double', '§7experience.', '§9Fortune II', '§7Grants §a+20 §6☘ Mining', '§6Fortune§7, which increases your', '§7chance for multiple drops.', '§9Telekinesis I', '§7Block and mob drops go directly', '§7into your inventory.', '', '§6Ability: Mining Speed Boost §e§lRIGHT CLICK', '§7Grants §a+§a300%§7 §6⸕ Mining', '§6Speed §7for §a20s§7.', '§8Cooldown: §a120s', '', '§7§8This item can be reforged!', '§a§lUNCOMMON PICKAXE', '', '§7Obtained: §c<local-time timestamp="1628331780000"></local-time>']

lore_box_generator(lore).save("lore.png")
